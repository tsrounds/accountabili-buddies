...
const POOL: Omit<RoastMemberInput, 'rank'>[] = [
  {
    uid: 'u1', firstName: 'Diana', avatarSeed: 'seed-diana',
    personalGoal: 'Read 30 pages before bed', checkedInToday: true, completionPct: 92, streak: 12,
    gossip: [
      'Rearranges her bookshelf by color instead of actually reading.',
      'Owns three copies of Infinite Jest, has finished zero.',
    ],
  },
  {
    uid: 'u2', firstName: 'Marcus', avatarSeed: 'seed-marcus',
    personalGoal: 'Run 3 miles every morning', checkedInToday: true, completionPct: 71, streak: 5,
    gossip: ['Posts the run to Strava before he even laces up.'],
  },
  ...
  {
    uid: 'u4', firstName: 'Teddy', avatarSeed: 'seed-teddy',
    personalGoal: 'Stretch for 10 minutes', checkedInToday: false, completionPct: 44, streak: 0,
    gossip: [
      "Bought a yoga mat in 2022, still in the plastic.",
      'Says "starting Monday" every Thursday.',
    ],
  },
  ...
  {
    uid: 'u6', firstName: 'Priya', avatarSeed: 'seed-priya',
    personalGoal: 'Meditate 15 minutes daily', checkedInToday: false, completionPct: 0, streak: 0,
    gossip: ['Downloaded four meditation apps this year and used none of them.'],
  },
